...
{
  # TODO: refactor this! this is actually in nixpkgs-unstable, but currently this configuration uses nixpkgs stable. use nixpkgs unstable for this package
  boot.extraModulePackages =
    let
      kernel = config.boot.kernelPackages.kernel;
      nct6687d = with pkgs; stdenv.mkDerivation rec {
        pname = "nct6687d";
